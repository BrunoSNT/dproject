...
class AdvertisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertise" do
    assert_difference('Advertise.count') do
      post advertises_url, params: { advertise: { client_id: @advertise.client_id, description: @advertise.description, end: @advertise.end, price: @advertise.price, release: @advertise.release, title: @advertise.title, type: @advertise.type } }
    end
  ...
  test "should update advertise" do
    patch advertise_url(@advertise), params: { advertise: { client_id: @advertise.client_id, description: @advertise.description, end: @advertise.end, price: @advertise.price, release: @advertise.release, title: @advertise.title, type: @advertise.type } }
